  ...
  return (
    <div className="sidebar" style={{ width: drawer ? "20%" : "5%" }}>
      <nav>
		...
		<li>
            <NavLink to="/" onClick={() => handleId(t("aside.event"))}>
              <img width={25} src={Group} alt="icon" />
          ...
          <li>
            ...
            >
              <img width={24} src={Homework} alt="icon" />
              {drawer && t("aside.homework")}
            </NavLink>
          </li>
          <li>
            <NavLink to={"/grade"} onClick={() => handleId(t("aside.baho"))}>
              <img width={25} src={Grade} alt="icon" />
              {drawer && t("aside.baho")}
            </NavLink>
          </li>
